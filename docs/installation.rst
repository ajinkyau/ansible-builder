...
.. note::
   ...
   An **alternative** approach to installing ``ansible-builder`` is using the ``ansible-dev-tools`` package.
   ...
   set up a development environment, generate new collections, build and test the content.
